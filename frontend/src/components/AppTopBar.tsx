...
export function AppTopBar({ trailing }: Props) {
  return (
    <div className="flex min-w-0 shrink-0 flex-col gap-3 border-b border-neutral-200 bg-white px-4 py-3 lg:flex-row lg:items-start lg:justify-between lg:gap-4">
